...
public class GeradorDeArquivo {
    public void salvarListaJson(List<ConversorEmPares> conversoes) throws IOException {
        ...
        String nomeArquivo = "src/main/java/com/conversormoedas/util/historico/" + formatoData.format(dataAtual) + ".json";

        File diretorio = new File("src/main/java/com/conversormoedas/util/historico");
        if (!diretorio.exists()) {
            diretorio.mkdirs();
        }
